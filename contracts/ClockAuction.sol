...
contract ClockAuction is Pausable, Ownable, ClockAuctionBase {
    ...
    constructor(address _nftAddress, uint256 _cut) {
        require(_cut <= 10000, "_cut should be smaller than or equal to 1000");
        ownerCut = _cut;
        
        IERC721 candidateContract = IERC721(_nftAddress);
        require(candidateContract.supportInterface(type(IERC721).interfaceId), "this contract doesn't supports ERC721 standard")
    ...
    function withdrawBalance() external {
        ...
        require(
            ...
            "you're not the owner per nftAddress"
        );
